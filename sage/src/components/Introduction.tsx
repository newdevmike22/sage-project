...
const Introduction = () => {
  return (
    <div className={`${inter.className} introduction`}>
      ...
      <p>Therefore, I, Sister Sage, have assembled a database of every major player in this deadly game of chess. I have documented each player&apos;s abilities, strengths, weaknesses, and, should the need ever arise, a contingency plan for how to neutralize—or even eliminate—them.</p>
    </div>
  );
};
