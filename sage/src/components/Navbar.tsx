...
const menuItems = [
  {
    title: "the boys",
    links: [
      { name: "Billy Butcher", href: "/characters/billy-butcher" },
      { name: "Frenchie", href: "/characters/frenchie" },
      { name: "Hughie Campbell", href: "/characters/hughie-campbell" },
      { name: "Kimiko Miyashiro", href: "/characters/kimiko-miyashiro" },
      { name: "Mother's Milk", href: "/characters/mothers-milk" },
      { name: "Ryan Butcher", href: "/characters/ryan-butcher" },
      { name: "Starlight", href: "/characters/starlight" },
    ],
  },
  {
    title: "heroes",
    links: [
      { name: "A-Train", href: "/characters/a-train" },
      { name: "Black Noir I", href: "/characters/black-noir-one" },
      { name: "Black Noir II", href: "/characters/black-noir-two" },
      { name: "Firecracker", href: "/characters/firecracker" },
      { name: "Homelander", href: "/characters/homelander" },
      { name: "Oh Father", href: "/characters/oh-father" },
      { name: "Queen Mauve", href: "/characters/queen-mauve" },
      { name: "Soldier Boy", href: "/characters/soldier-boy" },
      { name: "Stormfront", href: "/characters/stormfront" },
      { name: "The Deep", href: "/characters/the-deep" },
    ],
  },
  {
    title: "vought",
    links: [
      { name: "Ashley Barrett", href: "/characters/ashley-barrett" },
      { name: "Marie Moreau", href: "/characters/marie-moreau" },
      { name: "Stan Edgar", href: "/characters/stan-edgar" },
      { name: "Dr. Thomas Godolkin", href: "/characters/thomas-godolkin" },
      { name: "Victoria Neuman", href: "/characters/victoria-neuman" },
    ],
  },
];
